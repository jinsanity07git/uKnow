...
render(){
    ...
    return(
        ...
        <div className="col-md-6">
            ...
            <div class="card" style={{margin:'5px' , width: '30rem' ,textAlign: 'center',backgroundColor:'#323232'}}>
             ...
             */}
                ...
                <div class="card-body" style={{color:"#FFFFFF"}} >
                    ...
                    <div class=" mb-3" style={{margin:'auto' , width: '60%' ,textAlign: 'left', backgroundColor:'#323232'}}>
